...
l3fw_policy_facts - Facts about firewall policies
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
* Firewall policies are used on firewalls. This fact module also provides information about linked policies, such as inspection policies and the parent policy template.
...
.. raw:: html
    ...
    <td align=center>[{'comment': None, 'inspection_policy': 'High-Security Inspection Policy', 'name': 'Virtual Firewall Policy', 'template': 'Firewall Inspection Template', 'tags': ['footag'], 'file_filtering_policy': 'Legacy Anti-Malware', 'type': 'fw_policy'}]</td>
    </tr>
    </table>
    </br></br>

...
category_facts - Facts about category tag elements in the SMC
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
* Category tags can be added to most elements in the SMC to identify elements and for grouping purposes.
...
.. raw:: html
    ...
    <td>categories</td>
    <td>
        <div>Return categories and references using 'smc' as filter</div>
    </td>
    <td align=center>always</td>
    <td align=center>list</td>
    <td align=center>[{'comment': None, 'references': [{'type': 'host', 'name': '172.18.1.135'}], 'type': 'category_tag', 'name': 'smc-python'}]</td>
    </tr>
    </table>
    </br></br>

...
* A policy-based VPN provides VPN functionality between VPN gateways, or between mobile VPN users and VPN gateways.
...
.. raw:: html
	...
	<td>
        <p>Optionally expand element attributes that contain only HREF. You can also specify the name of an internal VPN gateway or an external VPN gateway to expand its contents.</p>
	</td>
	</tr>
    </td>
    </tr>

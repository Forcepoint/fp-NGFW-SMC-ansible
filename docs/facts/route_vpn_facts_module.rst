...
route_vpn_facts - Facts about route-based VPNs
++++++++++++++++++++++++++++++++++++++++
...
* Route-based VPN definitions in the SMC. The route-based VPN module supports element expansion by providing the expand parameter with a valid choice. You can provide any or all of the supported expandable fields in any given run.

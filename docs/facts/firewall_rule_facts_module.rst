...
firewall_rule_facts - Facts about firewall access rules in the specified policy
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
    ...
    <td></td>
	<td>
        <p>Provide a rule range to retrieve. Firewall access rules will be displayed based on the ranges provided in a top down fashion. Mutual exclusive with 'search'.</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>Provide a search string to use as a match against a rule's name or comments field. Mutually exclusive with <em>rule_range</em>.</p>
	</td>
	</tr>
    </td>
    </tr>

...
* An external VPN gateway is a VPN gateway that is not managed by the SMC to which you are connected. It defines the remote side networks and settings specific to handling VPNs. Use expand to specify attributes that should be resolved to raw data instead of HREF data.
...
.. raw:: html
	...
	<td>
        <p>Expand sub elements that only provide HREF data. Specify a list of external VPN gateways by name.</p>
	</td>
	</tr>
    </td>
    </tr>

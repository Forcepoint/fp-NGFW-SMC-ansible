...
firewall_nat_rule_facts - Facts about NAT based int the specified policy
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
	...
	<td>
        <p>Set this parameter to true if the output should be exported into YAML format. By default the output format is actually dict, but using this field allows you to also use the provided jinja templates to format into YAML and reuse for playbook runs.</p>
	</td>
	</tr>
    </td>
    </tr>
	...
	<td>
        <p>Fields that should be expanded from HREF into their native elements. Expanded fields will be returned as a dict of lists with the key being the element type and list being the name values for that element type.</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>The name of the Firewall Policy for which to retrieve rules</p>
	</td>
	</tr>
    </td>
    </tr>

...
.. raw:: html
    ...
    <td></td>
	<td>
        <p>Maximum number of times to repeat status checks. If the policy is in a 'wait' status, such as when there is no connectivity to the NGFW Engine, this will only block for max_tries * sleep.</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>Name of the NGFW Engine on which to install the policy</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>The policy to install. If the NGFW Engine does not have an existing policy then specifying a policy is required. If an NGFW Engine has an existing policy, a refresh of that existing policy is done.</p>
	</td>
	</tr>
    </td>
    </tr>

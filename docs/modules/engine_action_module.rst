...
* Perform a node-level action on the NGFW Engine such as go_online, go_offline, generate initial_contact, or reboot.
...
.. raw:: html
	...
	<td>
        <p>Action to perform on the NGFW Engine node. Some actions will optionally have additional arguments that can be provided.</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>Extra arguments to provide to the action constructor. Arguments documented only show action choices that have specific extra_args that are useful when calling the action. Constructor arguments are documented at <a href='http://smc-python.readthedocs.io/en/latest/pages/reference.html#module-smc.core.node'>http://smc-python.readthedocs.io/en/latest/pages/reference.html#module-smc.core.node</a></p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>Provide the name of the NGFW Engine for which to perform a node operation.</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>Provide a nodeid for the NGFW Engine node for which to perform the action. For single NGFW Engines this is not required and will default to nodeid 1. For clusters, each node has a nodeid to represent which node to operate on.</p>
	</td>
	</tr>
    </td>
    </tr>

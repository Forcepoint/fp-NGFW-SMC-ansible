...
.. raw:: html
    ...
    <td></td>
	<td>
        <p>A list of IP addresses to use as DNS resolvers for the firewall.</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td><ul><li>yes</li><li>no</li></ul></td>
	<td>
        <p>Enable Sidewinder proxy capability on the firewall</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
    <td>
        <div>List of interface definitions for this firewall</div>
    </tr>
    ...
    <td></td>
	<td>
        <p>Location for this firewall. Used for firewalls that are behind NAT</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
	<td>
        <p>The management interface ID. If the intent is to create a firewall, <code>interfaces</code> must also be specified with a matching interface_id.</p>
	</td>
	</tr>
    </td>
    </tr>

...
* Manage a policy-based VPN. This module provides the ability to fully create a VPN, along with modifying central and satellite gateways, as well as tags. Only satellite gateways, central gateways and tags can be deleted. All other options provided in the constructor can be modified or added.
...
.. raw:: html
    ...
    <td></td>
    <td>
        <div>Central gateways to add to the policy-based VPN. Can be internal VPN gateways managed by this SMC or external VPN gateways that are not managed by this SMC.</div>
    </tr>
    ...
    <td></td>
	<td>
        <p>The name of the policy-based VPN</p>
	</td>
	</tr>
    </td>
    </tr>
    ...
    <td></td>
    <td>
        <div>Satellite gateways to add to the policy-based VPN. Can be internal VPN gateways managed by this SMC or external VPN gateways that are not managed by this SMC.</div>
    </tr>
    ...
    <td></td>
	<td>
        <p>Optional VPN profile to use for this policy-based VPN</p>
	</td>
	</tr>
    </td>
    </tr>

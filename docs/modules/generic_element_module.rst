...
.. raw:: html
    ...
    <td></td>
    <td>
        <div>A list of the elements to create, modify or delete</div>
    </tr>
    ...
    <td colspan="5">
        ...
        <td></td>
        <td>
            <div>Specify the type of attribute for the given element. This value is the API entry point that correlates to the given smc-python object instance.</div>
        </td>
        </tr>
...
.. raw:: html
    ...
    <td align=center>[{'action': 'none', 'name': 'MyVPNProfile', 'typeof': 'vpn_profile'}]</td>
    </tr>

    <tr>
    <td>changed</td>
    <td>
        <div>Whether or not an element was changed</div>
    </td>
    <td align=center>always</td>
